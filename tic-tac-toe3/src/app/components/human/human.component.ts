...
export class HumanComponent implements OnInit {
  ...
  setUpHumanHumanGame(numberOfRounds: number): void {
        ...
        if (this.bestOf.setUp.status === 'ONGOING') {
          ...
          if (this.tiles[boardPosition].text === ' ') {
            ...
            this.moveService.performMove(this.bestOf).subscribe(moveData => {
              ...
              myCount = 0;
              console.log("Current game status: " + moveData.setUp.status);
              ...
              if(moveData.setUp.countMoves > 4) {
                ...
                console.log("Current round status: " + bestOfData.isOver);
                console.log("P1: " + bestOfData.score1);
                console.log("P2: " + bestOfData.score2);
